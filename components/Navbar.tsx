...
const Navbar = () => {
 ...
 function handleClick(e:any){
  ...
  <Link href="#project"
     ...
     <span 
     className="font-medium uppercase text-textDark inline-flex relative cursor-pointer h-7
  ...
  <Link href="#contact"
     ...
     overflow-x-hidden group">
      CONTACT
       ...
       duration-500"></span>
        ...
        <a href="/assets/naan.pdf" target="_blank">
        <motion.button
        ...
        {/* Small Icon section*/}
        <div onClick={()=>setShowMenu(true)} className="w-6 h-5 flex flex-col justify-between items-center
        mdl:hidden text-4xl text-textGreen cursor-pointer overflow-hidden group">
        ...
        {showMenu && (
            ...
            flex flex-col items-center px-4  py-10 relative">
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <Link className="flex items-center gab-1 font-medium text-textDark
            ...
            initial={{ y: 20, opacity:0 }} 
            animate={{ y: 0, opacity:1 }}
            transition={{ duration: 0.2, delay: 0.2, ease: "easeIn" }}><span 
              className="text-textGreen">01.</span>About</motion.li></Link>
            ...
            <span className="text-textGreen">02.</span>Experience</motion.li></Link>
            ...
            <span className="text-textGreen">03.</span>Project</motion.li></Link>
            ...
            transition={{ duration: 0.2, delay: 0.5 }}>
              <span className="text-textGreen">04.</span> Contact</motion.li></Link>
                </ul>
        <a href="/assets/naan.pdf" target="_blank">
        <motion.button
         initial={{ opacity:0 }} 
      ...
      animate={{y: 0, opacity:1}}
      transition={{delay: 0.6, ease: "easeIn"}}
      href="https://github.com/Felitech26" target="_blank">
      <span className="w-10 h-10 text-xl bg-hoverColor border-[1px] border-zinc-700
      hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center
      justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all
      duration-300">
            <TbBrandGithub />
          </span>
        </motion.a>
      ...
      duration-300">
        ...
        href="https://web.facebook.com/felix.abada.52" target="_blank">
           <span className="w-10 h-10 text-xl bg-hoverColor border-[1px] border-zinc-700
      hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center
      justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all
      duration-300">
    ...
    href="mailto:my25.glory.65@gmail.com">
