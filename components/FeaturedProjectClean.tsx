        ...
        <section className="py-12 px-6 lg:px-32">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="group grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-16 items-center">
                    ...
                    {/* Image Side */}
                    <div className="relative aspect-[16/10] w-full overflow-hidden rounded-sm bg-neutral-100 dark:bg-neutral-900 shadow-2xl shadow-black/5 dark:shadow-white/5 order-2 lg:order-1">
                        <Image
                            src={goparkly}
