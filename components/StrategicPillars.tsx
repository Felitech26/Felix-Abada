        ...
        <section className="py-24 px-6 lg:px-32">
            <div className="max-w-7xl mx-auto">
                ...
                <motion.div
                    ...
                    className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-current opacity-100 border border-current border-opacity-10"
                >
              ...
              `}
                    ...
                    <motion.div
                        variants={itemVariants}
                        className={`relative p-10 h-[320px] flex items-center justify-center
